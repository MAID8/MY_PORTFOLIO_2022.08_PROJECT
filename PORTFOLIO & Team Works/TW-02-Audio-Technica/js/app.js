...
//  // 공지사항/갤러리 tab 버튼
//  $('.tbContainer .info-btn').click(function () {
//   // 텝 초기화
//   $('.tbContents, .delivery-btn, .bank-btn').removeClass('on');
//   // 표시
//   $('#info, .info-btn').addClass('on');
// });

//  $('.tbContainer .delivery-btn').click(function () {
//   // 텝 초기화
//   $('.tbContents, .info-btn, .bank-btn').removeClass('on');
//   // 표시
//   $('#delivery, .delivery-btn').addClass('on');
// });

//  $('.tbContainer .bank-btn').click(function () {
//   // 텝 초기화
//   $('.tbContents, .delivery-btn, .info-btn').removeClass('on');
//   // 표시
